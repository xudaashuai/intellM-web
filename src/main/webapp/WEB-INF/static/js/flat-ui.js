	...
	zIndex: function( zIndex ) {
		...
		if ( this.length ) {
			...
			while ( elem.length && elem[ 0 ] !== document ) {
				// Ignore com.z-index if position is set to a value where com.z-index is ignored by the browser
				...
				if ( position === "absolute" || position === "relative" || position === "fixed" ) {
					...
					// <div style="com.z-index: -10;"><div style="com.z-index: 0;"></div></div>
	...
	createWrapper: function( element ) {
		...
		if ( element.css( "position" ) === "static" ) {
			...
			$.extend( props, {
				...
				zIndex: element.css( "com.z-index" )
			});
